...
FROM (
    SELECT 
        ...
        f.ID_WYPOZYCZALNIA_PRACOWNIK AS WYPOSYCZALNIA_ID,
        COUNT(DISTINCT f.ID_KLIENT) AS LICZBA_KLIENTOW
    FROM H_WYPOZYCZENIA f
...
LEFT JOIN H_WYPOZYCZALNIA wy ON agg.WYPOSYCZALNIA_ID = wy.ID
